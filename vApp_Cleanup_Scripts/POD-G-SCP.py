...
catalog_to_cleanup = 'ENM-SCP-STR-EVT'
...
pods = {'G' : 'https://atvpgspp16.athtem.eei.ericsson.se/'}
...
def get_valid_templates(sprint, pod, vapp_type, count):
    ...
    if vapp_type == "SCP" or vapp_type == "all" :
        vapp = ""
    elif vapp_type == "FULL":
        vapp = "_FULL"
    ...
    if sprint == "all":
        match_pattern="^ENM"+str(vapp)+"_SCP_*"
        #print "Match Pattern: ", match_pattern
    else:
        match_pattern="^ENM"+str(vapp)+"_SCP_STR_EVT_"+sprint+"_*"
        #print "Match Pattern: ", match_pattern
...
#    enm_vapp_template_delete_dict={}
    ...
    for pod in ['G']:
        print "\n\n\n\n=================================="
        print "|             POD: "+pod+" SCP cleanup from ENM-SCP-STR-EVT area             |"
        print "----------------------------------"
        for type in ["SCP"]:
            enm_vapp_template_delete_dict={}
            valid_enm_vapp_template_dict = {}
    ...
    #            print "Sprint: "+str(sprint)+"\n"+"================="+"\n"
                vapp_template_dict = get_valid_templates(sprint, pods[pod], type) #SCP
    #            print "Valid template dict", vapp_template_dict
            ...
            print "Valid "+type+" templates"#, scp_valid_enm_vapp_template_dict
