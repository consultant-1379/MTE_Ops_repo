...
catalog_to_cleanup = 'ENM-Full-vApp-catalog-install'
...
pods = {'H' : 'https://atvphspp17.athtem.eei.ericsson.se/'}
...
#    enm_vapp_template_delete_dict={}
    ...
    for pod in ['H']:
        print "\n\n\n\n=================================="
        print "|             POD: "+pod+" cleanup from ENM-Full-vApp-catalog-install area           |"
        print "----------------------------------"
        for type in ["FULL"]:
            enm_vapp_template_delete_dict={}
            valid_enm_vapp_template_dict = {}
