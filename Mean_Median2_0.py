...
total = datetime.now()
cell_A,cell_B,cell_C,cell_D,cell_E,cell_I="A","B","C","D","E","I"
...
for ISO in existing_ISO_list:
	for i in range(2,row_count+1):
		if ws[cell_B+str(i)].value=="Delivered" and  ws[cell_I+str(i)].value!=0 and ws[cell_A+str(i)].value not in group_list and ws[cell_C+str(i)].value==ISO:
